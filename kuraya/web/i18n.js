...
const I18N = {
  "zh-CN": {
    "search.placeholder": "搜索演员 · 番号 · 发行商 · 导演",
    "sort.by": "排序方式",
    ...
    "clear": "清空",
    "delete.title": "移入废纸篓",
    "delete.description": "确定要将这部影片移入系统废纸篓吗？",
    "delete.note": "视频、NFO、封面和字幕会一起移动，可随时恢复。",
    "delete.cancel": "取消",
    "delete.action": "移入废纸篓",
    "delete.close": "关闭",
    "delete.pending": "正在更新片库…",
    "delete.failed": "移入废纸篓失败，影片已恢复",
    "copied": "已复制路径",
    "copyFailed": "复制失败，路径见悬停提示",
  },
  "zh-TW": {
    "search.placeholder": "搜尋演員 · 番號 · 發行商 · 導演",
    "sort.by": "排序方式",
    ...
    "clear": "清空",
    "delete.title": "移入垃圾桶",
    "delete.description": "確定要將這部影片移入系統垃圾桶嗎？",
    "delete.note": "影片、NFO、封面和字幕會一起移動，可隨時恢復。",
    "delete.cancel": "取消",
    "delete.action": "移入垃圾桶",
    "delete.close": "關閉",
    "delete.pending": "正在更新片庫…",
    "delete.failed": "移入垃圾桶失敗，影片已恢復",
    "copied": "已複製路徑",
    "copyFailed": "複製失敗，路徑見懸停提示",
  },
  "en": {
    "search.placeholder": "Search actors · numbers · distributors · directors",
    "sort.by": "Sort by",
    ...
    "clear": "Clear",
    "delete.title": "Move to Trash",
    "delete.description": "Move this movie to the system Trash?",
    "delete.note": "The video, NFO, cover, and subtitles will move together and can be restored.",
    "delete.cancel": "Cancel",
    "delete.action": "Move to Trash",
    "delete.close": "Close",
    "delete.pending": "Updating the library…",
    "delete.failed": "Could not move the movie to Trash; it has been restored",
    "copied": "Path copied",
